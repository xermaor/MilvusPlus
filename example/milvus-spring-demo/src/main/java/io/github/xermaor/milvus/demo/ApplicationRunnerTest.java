package io.github.xermaor.milvus.demo;

import com.google.common.collect.Lists;
import io.github.xermaor.milvus.demo.model.Face;
import io.github.xermaor.milvus.demo.model.Person;
...
import io.github.xermaor.milvus.plus.service.MilvusService;
...
public class ApplicationRunnerTest implements ApplicationRunner {
    ...
    private void countFace(Integer temp) {
        MilvusResp<Long> query = milvusService.
                ofQuery(Face.class)
                .eq(Face::getTemp, temp)
                .count();
        log.info("query temp 11--{}", GsonUtil.toJson(query));
    ...
    private void delFace(Integer temp) {
        MilvusResp<DeleteResp> remove = milvusService.ofDelete(Face.class).eq(Face::getTemp, temp).remove();
    ...
    public void vectorQuery() {
        ...
        MilvusResp<List<MilvusResult<Face>>> query = milvusService.ofQuery(Face.class).
    ...
    public void scalarQuery() {
        //标量查询
        MilvusResp<List<MilvusResult<Face>>> query2 = milvusService.ofQuery(Face.class)
